...
This README details how to install wsl, docker and minikube, etc. on Windows 10+
...
- repoen Terminal/Ubuntu and start docker: ```sudo systemctl start docker```
...
## Initial Development On Minikube
...
- wsl will not open browser. Open browser within Windows and point to url returned from command
